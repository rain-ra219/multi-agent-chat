...
export default function PipelineCanvas({ savedRoles }: { savedRoles: SavedRole[] }) {
    ...
    (e: React.DragEvent) => {
      ...
      const newNode: Node = {
        ...
        data: {
          ...
          question: "",
          model: type === "image" ? "gpt-image-2" : "deepseek",
          systemPrompt: "",
          result: "",
          prompt: "",
          image: "",
              ...
              <>
                ...
                <div>
                  ...
                  {savedRoles.length > 0 && (
                    <select
                      onChange={(e) => {
                        if (e.target.value) updateNodeData(selectedNode.id, { systemPrompt: e.target.value });
                        e.target.value = "";
                      }}
